...
! function(t) {
    ...
    var e = t.GreenSockGlobals || t,
        ...
        l = function(t) {
            var e = t.nodeType,
                i = "";
            if (1 === e || 9 === e || 11 === e) { if ("string" == typeof t.textContent) return t.textContent; for (t = t.firstChild; t; t = t.nextSibling) i += l(t) } else if (3 === e || 4 === e) return t.nodeValue;
            return i
        },
        c = document,
        d = c.defaultView ? c.defaultView.getComputedStyle : function() {},
        f = /([A-Z])/g,
        u = function(t, e, i, n) { var r; return (i = i || d(t, null)) ? (t = i.getPropertyValue(e.replace(f, "-$1").toLowerCase()), r = t || i.length ? t : i[e]) : t.currentStyle && (i = t.currentStyle, r = i[e]), n ? r : parseInt(r, 10) || 0 },
        g = function(t) { return t.length && t[0] && (t[0].nodeType && t[0].style && !t.nodeType || t[0].length && t[0][0]) ? !0 : !1 },
        p = function(t) {
            var e, i, n, r = [],
                o = t.length;
            for (e = 0; o > e; e++)
        ...
        w = 127995,
        x = 127999,
        M = function(t) { return (t.charCodeAt(0) - C << 10) + (t.charCodeAt(1) - S) + 65536 },
        ...
        k = function(t, e) {
            ...
            return i && (t = t.split("++").join("")),
                function() { return "<" + e + P + (t ? " class='" + t + (i ? n++ : "") + "'>" : ">") }
        },
        T = n.SplitText = e.SplitText = function(e, i) { if ("string" == typeof e && (e = T.selector(e)), !e) throw "cannot split a null element."; return h ? (this.elements = g(e) ? p(e) : [e], this.chars = [], this.words = [], this.lines = [], this._originals = [], this.vars = i || {}, void this.split(i)) : (t.location.href = "http://" + s + a + "?plugin=" + o + "&source=" + r, !1) },
        D = function(t, e, i) {
            var n = t.nodeType;
            if (1 === n || 9 === n || 11 === n)
        ...
        N = function(t, e) { for (var i = e.length; --i > -1;) t.push(e[i]) },
        E = function(t) {
            var e, i = [],
                n = t.length;
